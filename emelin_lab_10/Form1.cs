...
namespace emelin_lab_10
{
    public partial class Form1 : Form
    {
        ...
        {
            TeamParams.Add("NaVi", -4.5);
            TeamParams.Add("Monte", -3.7);
            TeamParams.Add("FAZE", -3.5);
            TeamParams.Add("NiP", -1.3);
            TeamParams.Add("Cloud9", -5.0);
            TeamParams.Add("VirtusPro", -2.5);
            TeamParams.Add("G2", -3.3);
            TeamParams.Add("Heroic", -3.9);
        }
